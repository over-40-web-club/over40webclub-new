  ...
  return (
    <div className="tos">
      ...
      <div className="tos-contents__wrapper">
        <p>
          この利用規約（以下、<b>本規約</b>）は、<b>運営者</b>
          がDiscordサーバー（以下、コミュニケーションツール）上で提供するオンラインコミュティ
        ...
        <main>
          ...
          <ol>
            ...
            <li>
              運営者は本サービスに関し、本規約のほか、ご利用にあたってのルール等、各種の定め（以下、
              <b>個別規定</b>
          ...
          <ol>
            ...
            <li>
              前項の規定にかかわらず、運営者は有料の個別サービスを提供し、またその範囲を変更することがありますが、有料の個別サービスについては、別途運営者が定める規約に基づく利用者登録を要するものとします。
            </li>
          </ol>
          ...
          <ol>
            ...
            <li>
              前項本文の定めるものを除き、本サービスおよび本サービスに関連する一切の情報についての著作権およびその他の知的財産権はすべて運営者または運営者にその利用を許諾した権利者に帰属し、ユーザーは無断で複製、譲渡、貸与、翻訳、改変、転載、公衆送信（送信可能化を含む）、伝送、配布、出版、営業使用等をしてはならないものとします。
            </li>
          </ol>
          ...
          <ol>
            <li>
              ...
              <ol className="nest">
                ...
                <li>コミュニケーションツールの無料枠での使用制限に達した場合</li>
                <li>
                  招待メールを送付から、3日以内にコミュニケーションツールへのサインイン及び自己紹介をおこなわない場合
                </li>
          ...
          <ol>
            ...
            <li>
              運営者は、本サービスに起因してユーザーに生じたあらゆる損害について一切の責任を負いません。ただし、本サービスに関する運営者とユーザーとの間の契約（本規約を含む）が消費者契約法に定める消費者契約となる場合、この免責規定は適用されません。
            </li>
            <li>
              前項ただし書に定める場合であっても、運営者は、運営者の過失（重過失を除く）による債務不履行または不法行為によりユーザーに生じた損害のうち特別な事情から生じた損害（運営者またはユーザーが損害発生につき予見し、または予見し得た場合を含む）について一切の責任を負いません。また、運営者の過失（重過失を除く）による債務不履行または不法行為によりユーザーに生じた損害の賠償は、ユーザーから当該損害が発生した月に受領した利用料の額を上限とします。
            </li>
            <li>
          ...
          <h4>第13条（個人情報の取扱い）</h4>
          <p>
            運営者は、本サービスの利用によって取得する個人情報については、運営者

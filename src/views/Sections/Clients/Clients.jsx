      ...
      <div className="tos">
        ...
        <div className="tos-contents__wrapper">
                      ...
                      <main>
                        ...
                        <h4 id="article-3">第3条（ユーザーIDおよびパスワードの管理）</h4>
                        <ol>
                          <li>
                        ...
                        <h4 id="article-4">第4条（利用料金および支払方法）</h4>
                        <ol>
                        ...
                        <h4 id="article-8">第8条（利用制限および登録抹消）</h4>
                        <ol>
                          <li>
                        ...
                        <h4 id="article-9">第9条（退会）</h4>
                        <p>ユーザーは、管理者の定める退会手続により、本サービスから退会できるものとします。</p>

                        <h4 id="article-10">第10条（保証の否認および免責事項）</h4>
                        <ol>
                          <li>
                        ...
                        <h4 id="article-11">第11条（サービス内容の変更等）</h4>
                        <p>
                        ...
                        <h4 id="article-13">第13条（個人情報の取扱い）</h4>
                        <p>
                          管理者は、本サービスの利用によって取得する個人情報については、管理者
                          <b>プライバシーポリシー</b>に従い適切に取り扱うものとします。
                        </p>

                        <h4 id="article-14">第14条（通知または連絡）</h4>
                        <p>
                        ...
                        <h4 id="article-15">第15条（権利義務の譲渡の禁止）</h4>
                        <p>
